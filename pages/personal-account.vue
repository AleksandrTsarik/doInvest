        ...
        <div class="container">
          <div class="personal-account__list">
            <div class="personal-account__item">
              <div class="personal-account__subtitle t-24">
                Как действующий участник рынка, развиваю сервисы по сбору аналитики. И если у вас
                есть задача получить ценную и сгруппированную информацию по рынку, то я и моя
                команда можем быть для вас полезными.
              </div>
